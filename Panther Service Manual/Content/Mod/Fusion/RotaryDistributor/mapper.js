...
function addMapper() {
	...
	for(i=0;i<themaps.length;i++) {
		...
		// the line below sets the border color
		b = getClassRGBColor(classes,"iborder",'ffd700');

		// the line below sets the fill color
		c = getClassRGBColor(classes,"icolor",'ffec8b');
